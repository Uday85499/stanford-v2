...
// High-quality stock images for student-focused sections
const stock = {
  studentsClass: "https://images.unsplash.com/photo-1580582932707-520aed937b7b?auto=format&fit=crop&w=1400&q=80",
  studentReading: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&w=1400&q=80",
  kidsLearning: "https://images.unsplash.com/photo-1588072432836-e10032774350?auto=format&fit=crop&w=1400&q=80",
  graduates: "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?auto=format&fit=crop&w=1400&q=80",
  curiousKid: "https://images.unsplash.com/photo-1427504494785-3a9ca7044f45?auto=format&fit=crop&w=1400&q=80",
  globalKids: "https://images.unsplash.com/photo-1509062522246-3755977927d7?auto=format&fit=crop&w=1400&q=80",
  scienceKids: "https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fit=crop&w=1400&q=80",
  artKids: "https://images.unsplash.com/photo-1607453998774-d533f65dac99?auto=format&fit=crop&w=1400&q=80",
};
    ...
    <div className="bg-canvas min-h-screen overflow-x-hidden">
      ...
      <section id="home" className="relative pt-32 pb-20 lg:pt-40 lg:pb-28">
        <div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-10 items-center">
          ...
          <motion.div style={{ y: heroParallax, opacity: heroFade }} className="relative h-[480px] lg:h-[560px]">
            ...
            >
              <img src={stock.studentsClass} alt="Students engaged in classroom learning" loading="eager" className="w-full h-full object-cover rounded-2xl" />
            </motion.div>
            <motion.div
            ...
            >
              <img src={stock.kidsLearning} alt="Young students" className="w-full h-full object-cover rounded-2xl" />
            </motion.div>
            <motion.div
        ...
        <div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="absolute inset-0 rounded-3xl overflow-hidden glass p-2">
              <img src={stock.studentReading} alt="Stanford students reading" className="w-full h-full object-cover rounded-2xl" />
            </div>
            <motion.div
      ...
      <section className="py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-4">
          ...
          >
            {[
              { img: stock.scienceKids, title: "Smart Classrooms", desc: "Interactive digital learning environments." },
        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          >
            {[
              ...
              { img: stock.artKids, title: "Creative Arts", icon: Users },
              { img: stock.globalKids, title: "Global Exchange", icon: Globe2 },
              { img: banner2, title: "Awards & Olympiads", icon: Trophy },
            ].map((a, i) => (
              <motion.div
                key={i} variants={scaleIn}
