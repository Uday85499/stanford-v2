...
import banner2 from "@/assets/school/banner2.webp";
import student1 from "@/assets/school/1.webp";
import chess from "@/assets/school/chess-img.webp";
import robotics from "@/assets/school/robotics-img.webp";
import dance from "@/assets/school/classical-dance-img.webp";
import martial from "@/assets/school/martial-arts-img.webp";
import yoga from "@/assets/school/yoga-img.webp";
import holistic from "@/assets/school/holistic-development-img.webp";
  ...
  return (
    <div className="bg-canvas min-h-screen overflow-x-hidden">
      ...
      <div aria-hidden className="pointer-events-none fixed inset-0 -z-10">
        <div className="absolute top-20 -left-32 h-96 w-96 rounded-full bg-[oklch(0.86_0.17_92/0.35)] blur-3xl float-slow" />
        <div className="absolute top-1/2 -right-32 h-[28rem] w-[28rem] rounded-full bg-[oklch(0.32_0.08_155/0.25)] blur-3xl float-slow" style={{ animationDelay: "2s" }} />
        <div className="absolute bottom-0 left-1/3 h-80 w-80 rounded-full bg-[oklch(0.78_0.18_85/0.25)] blur-3xl float-slow" style={{ animationDelay: "4s" }} />
      </div>
        ...
        <div className={`mx-auto max-w-7xl px-4`}>
          <div className={`glass rounded-2xl flex items-center justify-between px-4 py-3 transition-all ${scrolled ? "shadow-lg" : ""}`}>
            <a href="#home" className="flex items-center gap-3">
              <img src={logo} alt="Stanford International School" className="h-10 w-auto" />
            ...
            <nav className="hidden lg:flex items-center gap-1">
              {nav.map((n) => (
                <a key={n.href} href={n.href}
                   className="px-3 py-2 text-sm font-medium text-[var(--dark-green-deep)] rounded-lg hover:bg-[oklch(0.86_0.17_92/0.4)] transition">
                  {n.label}
                </a>
              ))}
            </nav>
      ...
      <section id="home" className="relative pt-32 pb-20 lg:pt-40 lg:pb-28">
        <div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-10 items-center">
          <div>
            <div className="glass-yellow inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-xs font-semibold text-[var(--dark-green-deep)] uppercase tracking-wider">
              <Sparkles className="h-3.5 w-3.5" /> A Legacy of Excellence — Est. 1995
            </div>
            <h1 className="mt-6 font-display text-4xl sm:text-5xl lg:text-6xl font-bold text-[var(--dark-green-deep)] leading-[1.05] text-balance">
              Shaping Future Leaders with{" "}
              <span className="relative inline-block">
                <span className="relative z-10 text-[var(--dark-green)]">30 Years</span>
                <span className="absolute inset-x-0 bottom-1 h-3 bg-[var(--yellow)] -z-0 rounded"></span>
              </span>{" "}
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="#admissions" className="btn-shine inline-flex items-center gap-2 rounded-xl bg-[var(--dark-green)] text-[var(--cream)] px-6 py-3.5 font-semibold hover:bg-[var(--dark-green-deep)] transition shadow-lg">
                Begin Your Journey <ArrowRight className="h-4 w-4" />
              </a>
              <a href="#about" className="inline-flex items-center gap-2 rounded-xl glass px-6 py-3.5 font-semibold text-[var(--dark-green-deep)] hover:bg-white/80 transition">
                Discover Our Legacy
              </a>
            </div>
            ...
            <div className="mt-10 grid grid-cols-3 gap-3">
              {[
                ...
                <div key={label} className="glass rounded-xl px-3 py-3 flex items-center gap-2">
          ...
          <div className="relative h-[480px] lg:h-[560px]">
            <div className="absolute top-0 right-0 w-[70%] h-[65%] rounded-3xl overflow-hidden glass p-2 rotate-2">
              <img src={heroBanner} alt="Campus" className="w-full h-full object-cover rounded-2xl" />
            </div>
            <div className="absolute bottom-0 left-0 w-[55%] h-[55%] rounded-3xl overflow-hidden glass p-2 -rotate-3">
              <img src={banner1} alt="Students" className="w-full h-full object-cover rounded-2xl" />
            </div>
            <div className="absolute bottom-8 right-4 glass-dark rounded-2xl p-5 w-56">
              <div className="flex items-center gap-1 text-[var(--yellow)]">
                {[0,1,2,3,4].map(i => <Star key={i} className="h-4 w-4 fill-[var(--yellow)]" />)}
              </div>
            ...
            <div className="absolute -top-4 -left-4 glass-yellow rounded-2xl p-4 w-44 hidden md:block">
        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className={`glass rounded-3xl p-7 group hover:-translate-y-1 transition-all duration-300`}>
                <div className={`h-14 w-14 rounded-2xl grid place-items-center mb-5 ${p.tone === "yellow" ? "bg-[var(--yellow)] text-[var(--dark-green-deep)]" : "bg-[var(--dark-green)] text-[var(--cream)]"}`}>
        ...
        <div className="mx-auto max-w-7xl px-4 grid lg:grid-cols-2 gap-12 items-center">
          <div className="relative h-[480px]">
            <div className="absolute inset-0 rounded-3xl overflow-hidden glass p-2">
              <img src={student1} alt="Stanford students" className="w-full h-full object-cover rounded-2xl" />
            </div>
            <div className="absolute -bottom-6 -right-6 glass-dark rounded-2xl p-6 w-52">
            ...
            <div className="absolute -top-6 -left-6 glass-yellow rounded-2xl px-5 py-4 flex items-center gap-3">
          ...
          <div>
            ...
            <div className="mt-8 grid sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={f} className="flex items-center gap-2 glass rounded-xl px-4 py-3">
            ...
            <a href="#contact" className="mt-8 btn-shine inline-flex items-center gap-2 rounded-xl bg-[var(--dark-green)] text-[var(--cream)] px-6 py-3.5 font-semibold hover:bg-[var(--dark-green-deep)] transition shadow-lg">
      ...
      <section className="py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            {[
              { img: chess, title: "Smart Classrooms", desc: "Interactive digital learning environments." },
              { img: robotics, title: "Advanced STEM Labs", desc: "Hands-on scientific exploration and robotics." },
              { img: martial, title: "Premium Sports Complex", desc: "Olympic-standard courts and coaching." },
            ].map((c, i) => (
      ...
      <section id="activities" className="py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              { img: robotics, title: "Robotics & Innovation", icon: Microscope },
              { img: dance, title: "Performing Arts", icon: Music2 },
              { img: chess, title: "Leadership & Strategy", icon: Brain },
              { img: martial, title: "Sports Excellence", icon: Dumbbell },
              { img: yoga, title: "Yoga & Mindfulness", icon: Sparkles },
              { img: holistic, title: "Holistic Development", icon: Users },
              { img: banner2, title: "Global Exchange", icon: Globe2 },
              { img: banner1, title: "Awards & Olympiads", icon: Trophy },
            ].map((a, i) => (
              <div key={i} className="relative h-64 rounded-2xl overflow-hidden group glass p-1.5">
                <div className="relative w-full h-full rounded-xl overflow-hidden">
                  ...
                  <div className="absolute top-3 right-3 grid place-items-center h-9 w-9 rounded-xl glass-yellow">
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4">
          <div className="glass-dark rounded-3xl p-10 lg:p-14">
        ...
        <div className="mx-auto max-w-7xl px-4">
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6">
            {[
              ...
              <div key={i} className="glass rounded-3xl p-7 relative">
      ...
      <section id="admissions" className="py-16">
        <div className="mx-auto max-w-7xl px-4">
          <div className="relative rounded-3xl overflow-hidden glass-dark p-10 lg:p-16 text-center">
            <div className="absolute -top-20 -left-20 h-80 w-80 rounded-full bg-[var(--yellow)] opacity-20 blur-3xl" />
            <div className="absolute -bottom-20 -right-20 h-80 w-80 rounded-full bg-[var(--dark-green-soft)] opacity-30 blur-3xl" />
            <div className="relative">
              ...
              <a href="#contact" className="mt-8 btn-shine inline-flex items-center gap-2 rounded-xl bg-[var(--yellow)] text-[var(--dark-green-deep)] px-8 py-4 font-bold hover:bg-[var(--yellow-deep)] transition shadow-xl">
            ...
            <div className="grid lg:grid-cols-4 gap-10">
              <div className="lg:col-span-2">
                ...
                <div className="mt-6 flex gap-3">
                  {["f","in","ig","yt"].map((s) => (
                    <a key={s} href="#" aria-label={s} className="h-10 w-10 grid place-items-center rounded-xl glass-yellow text-[var(--dark-green-deep)] font-bold text-xs uppercase hover:bg-[var(--yellow)] transition">{s}</a>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  {nav.map(n => (
                    <li key={n.href}><a href={n.href} className="text-sm text-[var(--muted-foreground)] hover:text-[var(--dark-green)] transition">{n.label}</a></li>
                  ))}
                </ul>
              </div>
